...
public:
    ...
    /// to HashTable::Equals().
    Status CodegenEquals(LlvmCodeGen* codegen, bool force_null_equality, llvm::Function** fn);
...
private:
    ...
    uint32_t IR_NO_INLINE HashRow(const uint8_t* expr_values, const uint8_t* expr_values_null) const
            noexcept;
...
private:
    ...
    Status ResizeBuckets(int64_t num_buckets, const NewPartitionedHashTableCtx* ht_ctx,
                         bool* got_memory);
