...
public:
    NewPartitionedAggregationNode(ObjectPool* pool, const TPlanNode& tnode,
...
private:
    ...
    typedef Status (*ProcessBatchFn)(NewPartitionedAggregationNode*, RowBatch*,
    ...
    typedef Status (*ProcessBatchStreamingFn)(NewPartitionedAggregationNode*, bool, RowBatch*,
                                              RowBatch*, NewPartitionedHashTableCtx*,
    ...
    bool IR_ALWAYS_INLINE TryAddToHashTable(NewPartitionedHashTableCtx* ht_ctx,
                                            Partition* partition, NewPartitionedHashTable* hash_tbl,
